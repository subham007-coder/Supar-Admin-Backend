...
const forgetPassword = async (req, res) => {
  ...
  if (!isAdded) {
    ...
    const body = {
      ...
      <p>A request has been received to change the password for your <strong>AR_Lashes</strong> account </p>
        ...
        <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@ar-lashes.com</p>

        <p style="margin-bottom:0px;">Thank you</p>
        <strong>AR_Lashes Team</strong>
             `,
    };
