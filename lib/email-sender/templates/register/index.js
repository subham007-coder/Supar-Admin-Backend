    ...
    <div style="background-color:#f2f3f8; padding-bottom:100px;">
      ...
      >
        ...
        <p style="margin-bottom:20px;">Click this link for active your account</p></p>
                             ...
                             <a href="${process.env.SITE_FRONTEND_URL || 'http://localhost:5173'}/verify-email/${option.token}" style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verify Account</a>
