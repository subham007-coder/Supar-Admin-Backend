    ...
    <div style="background-color:#f2f3f8; padding-bottom:100px;">
                                      ...
                                      <tr>
                                        <td style="width:150px;">
                                          ...
                                          <img
                                            alt
                                            height="auto"
                                            src="https://nail-website-delta.vercel.app/assets/logo2.PNG"
                                            style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:80px;font-size:13px;padding-bottom:30px; background-color: #000;"
                                            width="80"
                                            height="80"
                                          />
                                        </td>
      ...
      >
                      ...
                      <tr>
                        ...
                        >
                          ...
                          >
                            ...
                            <p>Verify your email address to complete the signup and login into your <strong>AR_Lashes</strong> account.
                            </p>
        ...
        <p style="margin-bottom:20px;">Click this link for active your account</p></p>
                             ...
                             <a href="${process.env.STORE_URL || 'http://localhost:5173'}/verify-email/${option.token}" style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verify Account</a>

                            <p style="margin-top: 35px;">If you did not initiate
                              this request, please contact us immediately at
                              support@ar-lashes.com</p>
